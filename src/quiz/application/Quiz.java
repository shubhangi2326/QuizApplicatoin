...
opt4.setFont(new Font("Dialog",Font.PLAIN,20));
  add(opt4);
   ...
   lifeline.setBackground(new Color(30,144,255));
    ...
    sumit.setBounds(1100,710,200,40);
   sumit.setFont(new Font("Tahona",Font.PLAIN,22));
...
{
    super.paint(g);
    String time= "Timer left - " + timer + "second";
